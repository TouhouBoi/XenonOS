        ...
        switch ($data['group'])
        {
            case 'url':
                ...
                switch ($data['type'])
                {
					...
					<tbody>
					<tr>
					<td style="vertical-align: top; text-align: center;">' . $xenonNavIcon . '<td style="vertical-align: top; white-space: nowrap;">
					<div>The website
					...
					<br>
					<div>- xenonNavigator NextGeneration<br>
					</div>
					</td>
					</tr>
					</tbody>
                    ...
                    case 'external':
                        switch ($data['error'])
                        {
                            ...
                            case 2:
								...
								<tbody>
								<tr>
								<td style="vertical-align: top; text-align: center;">' . $xenonNavIcon . '<td style="vertical-align: top; white-space: nowrap;">xenonNavigator
								NG:<br>
								<div><br>
								Engine: ' . $GLOBALS['_scriptname'] . ' ' . $GLOBALS['_version'] . ' (A fork of PHProxy by Abdullah Arif)<br>
								Author: Fabian Olesen<br>
								Based on the Plugin for xenonNavigator by Lars SH.<br>
								<br>
								Capabilities:<br>
